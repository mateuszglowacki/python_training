...
class ContactHelper:
    ...
    def modify_contact_by_id(self, contact):
        wd = self.app.wd
        # init contact edition
        text = "edit.php?id=" + str(contact.id)
        wd.find_element_by_css_selector("a[href*='%s']" % text).click()
        # edit contact
        self.fill_contact_form(contact)
        # submit contact update
        wd.find_element_by_name("update").click()
    ...
    def get_contact_info_from_edit_page(self, index):
        ...
        return Contact(firstname=firstname, lastname=lastname, id=id, phone=homephone, work=workphone, mobile=mobilephone, phone2=secondaryphone, email1=email1, email2=email2, email3=email3, mainaddress=address)
